...
CUDA_CACHE_DISABLE=1 python ../run.py --lr $lr --b $batch-size --n_class 6 --n-epochs 30 \
--freqm $freqm --timem $timem --mixup ${mixup} \
--data-train ${data_dir}tr.json --data-val ${data_dir}val.json --label-csv ${data_dir}class_labels_indices.csv --exp-dir $exp_dir \
